...
/* CPSW_WR */
#define CPSW_WR_C0_RX_THRESH_EN	(CPSW_WR + 0x10)
#define CPSW_WR_C0_RX_EN	(CPSW_WR + 0x14)
...
#define CPSW_CPDMA_RX_INTMASK_SET	(CPSW_CPDMA + 0xa8)
#define CPSW_CPDMA_EOI_VECTOR	(CPSW_CPDMA + 0x94)

/* CPSW_CPDMA_RX_INTMASK_SET */
#define CPSW_CPDMA_RX_INTMASK_SET_RX0_PEND_MASK_BIT	(0)

/* CPSW_CPDMA_TX_CONTROL */
#define CPSW_CPDMA_TX_CONTROL_TX_EN_BIT	(0)
#define CPSW_CPDMA_RX_CONTROL_RX_EN_BIT	(0)

/* CPSW_CPDMA_EOI_VECTOR */
#define CPSW_CPDMA_EOI_VECTOR_RX_THRESH_PULSE	(0)
#define CPSW_CPDMA_EOI_VECTOR_RX_PULSE	(1)
