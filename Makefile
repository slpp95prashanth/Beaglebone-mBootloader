...
export CFLAGS+= -fno-builtin -fno-stack-protector -Wall -Os -mcpu=cortex-a8
...
LIBS_PATH:= -L /usr/lib/gcc-cross/arm-linux-gnueabi/9/
...
%.o: %.c
	$(CC) $(LIBS_PATH) $(LIBS) $(CFLAGS) $(INCDIR) -c $< -o $@
